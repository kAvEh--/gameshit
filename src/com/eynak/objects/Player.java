...
public class Player {
	...
	public Player(int _id, String _nameEn, String _nameFa, String _imagePath,
			String _nationality, int _playNum, String _ch1, String _ch2,
			String _ch3, String _ch4, String _ch5, String _ch6, String _ch7) {
		super();
		this._id = _id;
	...
	public void set_playNum(int _playNum) {
		this._playNum = _playNum;
	}
